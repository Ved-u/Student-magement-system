...
public class Student extends JFrame implements FocusListener
{		
 		//Declaring Variables
		...
		JLabel jmstudentid, jmstudentname, jmpreaddress, jmpermaaddress,  jmfathername, jmgender, jmcourse, jmyear,  jmlabel, 		jmdob, jmfatheroccupation, jmphone; 
		...
		JTextField tmid, tmname, tmpreaddress, tmpermaaddress, tmphone, tmdob, tmfathername, tmfatheroccupation;
...
//-----------Starting with the displayPanel1() method to create the Login panel
		...
		void displayPanel2() //ADD STUDENT  DETAILS TAB 
		{
				  ...
				  rollno = new JLabel("Student Id");	
				   rollno.setFont(dFont);		
						gbc1.fill = GridBagConstraints.BOTH;		
						gbc1.ipady = 1;       						
						gbc1.ipadx = 2;  
						gbc1.gridx = 0;       						     
			        	gbc1.gridy = 0;       						
			        	grid.setConstraints(rollno, gbc1);
			       	pan2.add(rollno);
				...
				txtrollno.addFocusListener(this);      						
			        	grid.setConstraints(txtrollno, gbc1);
		...
		{
			if (fe.getSource()==txtrollno)
			{	

					txtrollno.setToolTipText("Enter Roll Number");
					txtrollno.setText(" ");
					tsname.setText(" ");
		...
		void displayPanel3() //MODIFY/DELETE STUDENT DETAILS TAB
		{
				   ...
				   cb_sname.addItem("Select Student Id");
				 ...
				 jmstudentid = new JLabel("Student Id");	
				  jmstudentid.setFont(dFont);		
						gbc2.fill = GridBagConstraints.BOTH;		
						gbc2.ipady = 1;       						
						gbc2.ipadx = 2;  
						gbc2.gridx = 0;       						     
			        	gbc2.gridy = 1;      
				grid.setConstraints(jmstudentid, gbc2);
			       	pan3.add(jmstudentid);
		...
		{		 	
			  ...
			  {			   		
			   ...
			   {
			    System.out.println("Unable to access the databaseverifyLogin"+ex);
			   }
		...
		void showResults(ResultSet r) 
		{
			...
			else
			{
			  ...
			  {
               			System.out.println("ZZZZZZZZZZZZZ:"+ex6);
			  }
		}	
	...
	void addRecord() 
		{
			...
			if( txtrollno.getText().equals("") || tsname.getText().equals("")||tspreaddress.getText().equals("")||tsfathername.getText().equals("")||tsphone.getText().equals("")||tspermaaddress.getText().equals("")||tsdob.getText().equals(""))
			{
	
				JOptionPane.showMessageDialog((Component) null, "Please Fill All the Fields");
			...
			else
			{
				  ...
				  {			  
					...
					while (rs.next()) 
					{
    					cnt++;     
						dbroll =rs.getInt(16);
					System.out.println(" database roll number "+dbroll); 					
					}
						...
						if(rollno1 != dbroll)
						{
							...
							reg_no = ""+cs+""+ss+"-"+cnt;
							query3 = "INSERT INTO student_details (name,preaddress,permaaddress,fathername,dateofbirth,fatheroccupation,phone,gender,year,course,dmc,degree,charcerti,ncccerti,rollno) VALUES ('"+tsname.getText()+"','"+tspreaddress.getText()+"','"+tspermaaddress.getText()+"','"+tsfathername.getText()+"','"+tsdob.getText()+"','"+foccupation+"','"+tsphone.getText()+"','"+gender+"','"+year+"','"+course+"',"+dmcsel+","+degreesel+","+charcfsel+","+ncccfsel+","+rollno1+")";
							...
							cb_sname.addItem(txtrollno.getText());
					...
					//Setting other textboxes as blank to enable new record entry
							...
							{
								JOptionPane.showMessageDialog( (Component) null, " This Student Id is alredy Exist");
		...
		{		 	
			  try
			  {		
					query4 = "SELECT * FROM student_details WHERE rollno="+nsel+"";
					Class.forName(driver);
			   		Connection con=DriverManager.getConnection(url);
			   		Statement st = con.createStatement();
			   ...
			   {
			    System.out.println("Unable to access the databaseaccessModifiedDatabase");
			   }
			  catch(ClassNotFoundException ex)
			   {
			    System.out.println("Class not found");
		...
		void showModifiedResults(ResultSet r) 
		{
				...
				try
			{
				...
				while(r.next())
				{
					...
					int12=r.getInt(15);
					 int16 =r.getInt(16);	
					System.out.println("setvala......................"+int16);	
				}
				tmid.setText(String.valueOf(int16));
				currentname = txt2;				
				tmname.setText(txt2);
		...
		{
               			System.out.println("Showmodifyresults:"+ex);
		}
	}
	...
	void accessStudName() //Retrieving the student list in the combo box
		{
		 	  try
			  {			  		
					query5 = "SELECT rollno,Name FROM student_details ORDER BY rollno"; 
					Class.forName(driver);
			   		Connection con=DriverManager.getConnection(url);
			   		Statement st = con.createStatement();
			   ...
			   {
			    System.out.println("Unable to access the database accessStudName"+ex);
			   }
			  catch(ClassNotFoundException ex)
			   {
			    System.out.println("Class not found");
		...
		void showStudName(ResultSet r) 
		{
			try
			{
				...
				{	
					...
					//System.out.println("++++++++++++++"+r.getInt(16));
					
					cb_sname.addItem(String.valueOf(r.getInt("rollno"))+": "+r.getString("name"));
					ctr_val++;					
				}
			}
			catch(Exception e5)
				{
				System.out.println("inside ...................showStudName"+e5);
				}	
		}
		...
		{		 	
			  ...
			  {		
					...
					Class.forName(driver);					
			   		Connection con=DriverManager.getConnection(url);
			   		Statement st = con.createStatement();	
			   		System.out.println("Delete Student id  is........................... :=="+nsel);
					query6 = "DELETE FROM student_details WHERE rollno ="+nsel;
			   ...
			   {
			    System.out.println("Unable to access the database delete");
			   }
			  catch(ClassNotFoundException ex)
			   {
			    System.out.println("Class not found");
		...
		void updateRecord(int std_id,String str_name) //Update Database when modified
		{
		 	  try
			  {
			   ...
			   {
			    System.out.println("Unable to access the database...........Update");
			   }
			  catch(ClassNotFoundException ex)
			   {
			    System.out.println("Class not found");
